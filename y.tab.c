...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_STAR_ASSIGN = 20,               /* STAR_ASSIGN  */
  YYSYMBOL_SLASH_ASSIGN = 21,              /* SLASH_ASSIGN  */
  ...
  YYSYMBOL_SINGLE_START = 43,              /* SINGLE_START  */
  YYSYMBOL_MULTI_START = 44,               /* MULTI_START  */
  YYSYMBOL_MULTI_END = 45,                 /* MULTI_END  */
  YYSYMBOL_LEFT_PAREN = 46,                /* LEFT_PAREN  */
  YYSYMBOL_RIGHT_PAREN = 47,               /* RIGHT_PAREN  */
  YYSYMBOL_LEFT_BRACE = 48,                /* LEFT_BRACE  */
  YYSYMBOL_RIGHT_BRACE = 49,               /* RIGHT_BRACE  */
  YYSYMBOL_LEFT_BRACKET = 50,              /* LEFT_BRACKET  */
  YYSYMBOL_RIGHT_BRACKET = 51,             /* RIGHT_BRACKET  */
  YYSYMBOL_IDENTIFIER = 52,                /* IDENTIFIER  */
  YYSYMBOL_ERROR = 53,                     /* ERROR  */
  YYSYMBOL_EOF_TOKEN = 54,                 /* EOF_TOKEN  */
...
static const char *const yytname[] =
{
  ...
  "INTEGER", "FLOAT", "CHARACTER", "STRING", "ASSIGN", "PLUS_ASSIGN",
  "MINUS_ASSIGN", "STAR_ASSIGN", "SLASH_ASSIGN", "MOD_ASSIGN", "PLUS",
  "MINUS", "STAR", "SLASH", "MOD", "INC", "DEC", "EQ", "LT", "GT", "LE",
  "GE", "QUESTION_MARK", "NE", "NOT", "AND", "OR", "COMMA", "SEMICOLON",
  "COLON", "SINGLE_START", "MULTI_START", "MULTI_END", "LEFT_PAREN",
  "RIGHT_PAREN", "LEFT_BRACE", "RIGHT_BRACE", "LEFT_BRACKET",
  "RIGHT_BRACKET", "IDENTIFIER", "ERROR", "EOF_TOKEN", "$accept",
  "program", YY_NULLPTR
};
